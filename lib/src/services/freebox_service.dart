...
class FreeboxService {
  ...
  static Future<List<dynamic>> fetchPhotosDir() async {
  ...
  static Future<void> uploadHive() async {
  ...
  static Future<Uint8List?> fetchImageBytes(String path, String mimetype) async {
